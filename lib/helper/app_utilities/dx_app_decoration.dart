...
class AppStyles {
  ...
  static TextStyle getTextStyle(bool isSemiBold, double fontSize,
      ...
      new TextStyle(
          ...
          fontSize: fontSize,
          fontFamily:
              isSemiBold ? AppFonts.textBold : AppFonts.textRegular);
  ...
  static TextStyle getTextStyleYellowH(bool isSemiBold, double fontSize) =>
      new TextStyle(
          fontFamily: AppFonts.textRegular1,
          fontWeight: isSemiBold ? FontWeight.w800 : FontWeight.w500,
          color: Color(0xffF5B65E),
          fontSize: fontSize);

  static TextStyle getTextStyleGreyMB(bool isSemiBold, double fontSize) =>
      new TextStyle(
  ...
  static TextStyle getTextStyleWhite1(bool isSemiBold, double fontSize) =>
      new TextStyle(
          fontFamily: AppFonts.textSemiBold,
          fontWeight: isSemiBold ? FontWeight.w800 : FontWeight.w500,
          color: Colors.white,
